...
namespace BTWInfraestructure.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        private Hashtable _repositories;
        private readonly BTWDbContext _context;


        public UnitOfWork(BTWDbContext context)
        {
            _context = context;
        }

        public BTWDbContext DbContext => _context;
